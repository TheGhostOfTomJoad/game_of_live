...
class RectangleDrawer(private val terminal: Screen) {
    ...
    private fun computeMaxSquareSizeHelper(
        gameBoardRows: Int, gameBoardColumns: Int, terminalRows: Int, terminalColumns: Int
    ): Int {
    ...
    fun drawSquareInner(i: Int, j: Int, color: TextColor) {
        drawSquareHelper(i * squareSize + 1, j * squareSize + 1, squareSize - 2, color)
    }
